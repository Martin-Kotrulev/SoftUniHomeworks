namespace OnlineShop.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<OnlineShopEntities>
    {
        ...
        private static void SeedAds(OnlineShopEntities context, ApplicationUser user, List<AdType> adTypes)
        {
        ...
        private List<Category> SeedCategories(OnlineShopEntities context)
        {
        ...
        private static ApplicationUser SeedUser(OnlineShopEntities context)
        {
        ...
        private static List<AdType> SeedAdTypes(OnlineShopEntities context)
        {
