...
//Each column should have a width of 10 characters. The number a 
//should be printed in hexadecimal, left aligned; then the number
//a should be printed in binary form, padded with zeroes, then
//the number b should be printed with 2 digits after the decimal
//point, right aligned; the number c should be printed with 
...
class FormattingNumbers
{
    static void Main()
    {
        ...
        Console.WriteLine("|{0, -10:X}|{1}|{2, 10: F2}|{3, -10:F3}|", a,
