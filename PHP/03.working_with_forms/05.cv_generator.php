...
Write a PHP script CVGenerator.php which generates an HTML 
form like in the example below. When the information is 
submitted (via Generate CV), the script should print out a 
simple table-like CV. Semantic HTML is required. Styling is 
not required. 
-->
<html>
    <head>
    ...
    <body>
        <form action="05.cv_generator.php" method="post">
            <fieldset>
            ...
            <fieldset>
                ...
                <section class="addRemove">
                    <button type='button' id="removeComputerLanguage">Remove Language</button>
                    <button type='button' id="addComputerLanguage">Add Language</button>
                </section>
            </fieldset>
            <fieldset>
        ...
        if (preg_match('/^[a-zA-Z]{2,20}$/', $firstName) &&
                preg_match('/^[a-zA-Z]{2,20}$/', $lastName) &&
                preg_match('/^[a-zA-Z0-9]{2,20}$/', $companyName) &&
                preg_match('/^\+?([0-9]+[- ]?)+$/', $phoneNumber) &&
